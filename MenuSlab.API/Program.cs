...
{
    opts.AUTH_SECRET_KEY = Environment.GetEnvironmentVariable("AUTH_SECRET_KEY") ?? "e5l848r64w,krruiewh9hgu94gjuu2.ttvte468d";
    opts.MAIN_DB_CONNECT_STRING = Environment.GetEnvironmentVariable("MAIN_DB_CONNECT_STRING") ?? "Host=localhost;Port=5432;Database=swinva_auth1db;Username=postgres;Password=admin;";
});
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "MenuslabAPI V1");
